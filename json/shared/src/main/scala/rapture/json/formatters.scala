...
private[json] class formatters_1 {
  ...
  protected def general[Ast <: JsonAst](
      json: Any, ln: Int, ast: Ast, pad: String = " ", brk: String = "\n")(
