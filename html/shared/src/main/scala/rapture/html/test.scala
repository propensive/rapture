...
object HtmlTest {
  ...
  val Table = Empty[Flow, NoAttributes, TableItems]()
  val Caption = Empty[TableItems, NoAttributes, Phrasing]()
  val Colgroup = Empty[TableItems, NoAttributes, ColItems](Optional)
  val Col = Empty[ColItems, NoAttributes, Nothing](EmptyTag)
  val Tbody = Empty[TableItems, NoAttributes, TrItems](Optional)
  val Thead = Empty[TableItems, NoAttributes, TrItems](Optional)
  val Tfoot = Empty[TableItems, NoAttributes, TrItems](Optional)
  val Tr = Empty[TrItems, Tr, TdItems](ClosingTagOptional)
  val Td = Empty[TdItems, NoAttributes, Flow](ClosingTagOptional)
  val Th = Empty[TdItems, NoAttributes, Flow](ClosingTagOptional)
...
object Testing {
  ...
  val test = Table(Tbody(Tr(style = css"color:bar")(Td)))
}
