...
object htmlSyntax {
  ...
  implicit def stringToTextNode(
      str: String): TextNode[Nothing, Nothing, Html5.Text] =
    TextNode[Nothing, Nothing, Html5.Text](str)

  type HtmlRoot = Element[Top, ElementType, Html]

  type HtmlElement[T <: ElementType] = Element[
      _ <: ElementType, _ <: T, _ <: AttributeType]
  ...
  def Video[T <: Embedded with Interactive] =
    Tag[T, T, Video]()(new AssignedName("Video"))
  def Audio[T <: Embedded with Interactive] =
    Tag[T, T, Audio]()(new AssignedName("Audio"))
  ...
  val Script = Tag[Text, Metadata with Phrasing, Script](
      forceClosingTag = true, block = true)
  ...
  val Textarea =
    Tag[Text, Phrasing with Interactive, Textarea](forceClosingTag = true)
  ...
  object Data extends Dynamic {
    ...
    def updateDynamic[E <: ElementType](att: String)(v: String) =
      selectDynamic(att).set[E](v)
  }
  ...
  implicit def translate =
    Attribute[Global, Boolean]("translate")(v => if (v) "yes" else "no")
  def translate_=[E <: ElementType](v: Boolean) = translate.set[E](v)

  implicit def classes =
    Attribute[Global, Seq[String]]("classes", "class")(_.mkString(" "))
  ...
  implicit def alt =
    Attribute[Img with Area with Input, String]("alt")(identity)
  def alt_=[E <: ElementType](v: String) = alt.set[E](v)

  implicit def href =
    Attribute[Base with Link with A with Area, PathLink]("href")(_.link)
  def href_=[E <: ElementType, L : Linkable](v: L) =
    href.set[E](implicitly[Linkable[L]].link(v))
  ...
  implicit def max =
    Attribute[Progress with Meter with Input, Double]("max")(_.toString)
  ...
  implicit def httpEquiv =
    Attribute[Meta, HttpEquiv]("httpEquiv", "http-equiv")(_.name)
  def httpEquiv_=[E <: ElementType](v: HttpEquiv) = httpEquiv.set[E](v)

  implicit def charset =
    Attribute[Meta with Script, Encoding]("charset")(_.name)
  ...
  implicit def target =
    Attribute[Base with Link with A with Area with Form with Input with Button,
              Symbol]("target")(_.name)
  ...
  trait MediaExpr
  sealed class Media(val name: String) extends MediaExpr {
    override def toString = name
  }
  sealed class Device(val name: String) extends MediaExpr {
    override def toString = name
  }
  ...
  implicit def media =
    Attribute[Link with Style with A with Source with Area, MediaExpr](
        "media")(_.toString)
  ...
  implicit def src =
    Attribute[Script with Img with Iframe with Embed with Video with Audio with Source with Input,
              PathLink]("src")(_.toString)
  def src_=[E <: ElementType, L : Linkable](v: L) =
    src.set[E](implicitly[Linkable[L]].link(v))

  implicit def value =
    Attribute[
        Li with Progress with Meter with Param with Input with Button with Option,
  ...
  implicit def action =
    Attribute[Form with Input with Button, PathLink]("action")(_.link)
  def action_=[E <: ElementType, L : Linkable](v: L) =
    action.set(implicitly[Linkable[L]].link(v))

  implicit def method =
    Attribute[Form with Input with Button, String]("method")(identity)
  def method_=[E <: ElementType](v: String) = method.set(v)

  implicit def enctype =
    Attribute[Form with Input with Button, String]("enctype")(identity)
  def enctype_=[E <: ElementType](v: String) = enctype.set(v)

  implicit def checked =
    Attribute[Input, Boolean]("checked")(v => if (v) "checked" else null)
  def checked_=[E <: ElementType](v: Boolean) = checked.set(v)

  implicit def maxlength =
    Attribute[Input with Textarea, Int]("maxlength")(_.toString)
  ...
  implicit def scoped =
    Attribute[Style, Boolean]("scoped")(v => if (v) "scoped" else null)
  def scoped_=[E <: ElementType](v: Boolean) = scoped.set(v)

  implicit def async =
    Attribute[Script, Boolean]("async")(v => if (v) "async" else null)
  def async_=[E <: ElementType](v: Boolean) = async.set(v)

  implicit def defer =
    Attribute[Script, Boolean]("defer")(v => if (v) "defer" else null)
  def defer_=[E <: ElementType](v: Boolean) = defer.set(v)

  implicit def onbeforeunload =
    Attribute[Body, Js]("onbeforeunload")(_.content)
  ...
  implicit def reversed =
    Attribute[Ol, Boolean]("reversed")(v => if (v) "reversed" else null)
  ...
  def ping_=[E <: ElementType, L : Linkable](v: L) =
    ping.set(implicitly[Linkable[L]].link(v))

  implicit def cite =
    Attribute[Blockquote with Q with Edit, PathLink]("cite")(_.link)
  def cite_=[E <: ElementType, L : Linkable](v: L) =
    cite.set(implicitly[Linkable[L]].link(v))

  implicit def datetime =
    Attribute[Time with Edit, String]("datetime")(identity)
  ...
  implicit def ismap =
    Attribute[Img, Boolean]("ismap")(v => if (v) "ismap" else null)
  def ismap_=[E <: ElementType](v: Boolean) = ismap.set(v)

  implicit def width =
    Attribute[
        Img with Iframe with Embed with Object with Video with Canvas with Input,
        Int]("width")(_.toString)
  def width_=[E <: ElementType](v: Int) = width.set(v)

  implicit def height =
    Attribute[
        Img with Iframe with Embed with Object with Video with Canvas with Input,
        Int]("height")(_.toString)
  def height_=[E <: ElementType](v: Int) = height.set(v)

  implicit def sandbox =
    Attribute[Iframe, Boolean]("sandbox")(v => if (v) "sandbox" else null)
  def sandbox_=[E <: ElementType](v: Boolean) = sandbox.set(v)

  implicit def seamless =
    Attribute[Iframe, Boolean]("seamless")(v => if (v) "seamless" else null)
  def seamless_=[E <: ElementType](v: Boolean) = seamless.set(v)

  implicit def poster = Attribute[Video, PathLink]("poster")(_.link)
  def poster_=[E <: ElementType, L : Linkable](v: L) =
    poster.set(implicitly[Linkable[L]].link(v))

  implicit def data = Attribute[Object, String]("data")(identity)
  def data_=[E <: ElementType](v: String) = data.set(v)

  implicit def autobuffer =
    Attribute[Video with Audio, Boolean]("autobuffer")(
        v => if (v) "autobuffer" else null)
  def autobuffer_=[E <: ElementType](v: Boolean) = autobuffer.set(v)

  implicit def autoplay =
    Attribute[Video with Audio, Boolean]("autoplay")(
        v => if (v) "autoplay" else null)
  def autoplay_=[E <: ElementType](v: Boolean) = autoplay.set(v)

  implicit def loop =
    Attribute[Video with Audio, Boolean]("loop")(v => if (v) "loop" else null)
  def loop_=[E <: ElementType](v: Boolean) = loop.set(v)

  implicit def controls =
    Attribute[Video with Audio, Boolean]("controls")(
        v => if (v) "controls" else null)
  ...
  implicit def acceptCharset =
    Attribute[Form, String]("accept-charset")(identity)
  def acceptCharset_=[E <: ElementType](v: String) = acceptCharset.set(v)

  implicit def autocomplete =
    Attribute[Form with Input, Boolean]("autocomplete")(
        v => if (v) "on" else "off")
  def autocomplete_=[E <: ElementType](v: Boolean) = autocomplete.set(v)

  implicit def novalidate =
    Attribute[Form with Input with Button, Boolean]("novalidate")(
        v => if (v) "novalidate" else null)
  def novalidate_=[E <: ElementType](v: Boolean) = novalidate.set(v)

  implicit def label =
    Attribute[Option with Command with Menu, String]("label")(identity)
  def label_=[E <: ElementType](v: String) = label.set(v)

  implicit def forName =
    Attribute[Option with Command with Menu, Symbol]("forName")(_.name)
  ...
  implicit def autofocus =
    Attribute[Input with Button with Select with Textarea, Boolean](
        "autofocus")(v => if (v) "autofocus" else null)
  ...
  implicit def multiple =
    Attribute[Input with Select, Boolean]("multiple")(
        v => if (v) "multiple" else null)
  ...
  implicit def readonly =
    Attribute[Input with Textarea, Boolean]("readonly")(
        v => if (v) "readonly" else null)
  def readonly_=[E <: ElementType](v: Boolean) = readonly.set(v)

  implicit def required =
    Attribute[Input with Textarea, Boolean]("required")(
        v => if (v) "required" else null)
  ...
  def icon_=[E <: ElementType, L : Linkable](v: L) =
    icon.set(implicitly[Linkable[L]].link(v))
