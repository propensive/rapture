...
lazy val raptureJVM = project.in(file(".raptureJVM"))
  ...
  .settings(raptureSettings)
  .aggregate(baseJVM, coreJVM, uriJVM, codecJVM, cryptoJVM, csvJVM, ioJVM, fsJVM, netJVM, mimeJVM, cliJVM, logJVM, i18nJVM, textJVM, latexJVM, testJVM, dataJVM, jsonJVM, jsonJawnJVM, jsonJfcJVM, jsonPlayJVM, jsonSprayJVM, jsonJson4sJVM, jsonArgonautJVM, jsonJacksonJVM, jsonLiftJVM, coreScalazJVM, coreTestJVM, i18nTestJVM, cliTestJVM, jsonTestJVM)
  .dependsOn(baseJVM, coreJVM, uriJVM, codecJVM, cryptoJVM, csvJVM, ioJVM, fsJVM, netJVM, mimeJVM, cliJVM, logJVM, i18nJVM, textJVM, latexJVM, testJVM, dataJVM, jsonJVM, jsonJawnJVM, jsonJfcJVM, jsonPlayJVM, jsonSprayJVM, jsonJson4sJVM, jsonArgonautJVM, jsonJacksonJVM, jsonLiftJVM, coreScalazJVM, coreTestJVM, i18nTestJVM, cliTestJVM, jsonTestJVM)
  
lazy val raptureJS = project.in(file(".raptureJS"))
  .settings(moduleName := "rapture")
  .settings(raptureSettings)
  .aggregate(baseJS, coreJS, uriJS, codecJS, cryptoJS, csvJS, ioJS, fsJS, netJS, mimeJS, cliJS, logJS, i18nJS, textJS, latexJS, testJS, dataJS, jsonJS, jsonJawnJS, jsonJfcJS, jsonLiftJS, jsonPlayJS, jsonSprayJS, jsonJson4sJS, jsonArgonautJS, jsonJacksonJS, coreScalazJS, coreTestJS, i18nJS, cliTestJS, coreTestJS, i18nTestJS, jsonTestJS)
...
// rapture-json-jfc
lazy val `json-jfc` = crossProject.dependsOn(json)
  .settings(moduleName := "rapture-json-jfc")
  .settings(raptureSettings:_*)
  .settings(libraryDependencies += "io.jfc" %% "jfc-core" % "0.1.0-SNAPSHOT")
  .settings(libraryDependencies += "io.jfc" %% "jfc-jawn" % "0.1.0-SNAPSHOT")
 
lazy val jsonJfcJVM = `json-jfc`.jvm
lazy val jsonJfcJS = `json-jfc`.js
...
// rapture-json-test
lazy val `json-test` = crossProject.dependsOn(`json-jawn`, `json-lift`, `json-spray`, `json-argonaut`, `json-jackson`, `json-play`, `json-json4s`, `json-jfc`, test)
